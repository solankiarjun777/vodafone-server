...
/**
 * This junit test cases for {@link TopUpsController} }
 * 
...
public class TopupsControllerTest {
	...
	/**
	 * Its success test case which test web service to fetch list of account holder from server
	 * @throws Exception
	 */
	...
	/**
	 * Its negative test case which test web service to fetch list of account holder from server
	 * @throws Exception
	 */

	@Test
	public void testAccountHolderNotAvailable() throws Exception {
		...
		System.out.println(result.getResponse().getContentAsString());
		String expected = "[{\"id\":\"12345\",\"name\":\"Karan's Family\",\"number\":\"9737363736\"},{\"id\":\"54321\",\"name\":\"Uday's Family\",\"number\":\"\"}]";
	...
	/**
	 * Its success test case which test web service for topup recharge
	 * @throws Exception
	 */
	...
	/**
	 * Its negative test case which test when mobile number not associated with account holder
	 * @throws Exception
	 */
	@Test
	...
	/**
	 * Its negative test case which test when recharge mobile number is invalid
	 * @throws Exception
	 */
	@Test
	public void testTopupWithoutSubscriberNumber1() throws Exception {
		
		String data = "{\"conversionID\":\"5555\",\"financialAccount\":\"54321\",\"phoneNumber\":\"89452378dd\",\"amount\":\"15\"}";
		RequestBuilder requestBuilder = MockMvcRequestBuilders
				.post("/topups/recharge")
				.accept(MediaType.APPLICATION_JSON).content(data)
				.contentType(MediaType.APPLICATION_JSON);
